...
class RadioButtonPage(BasePage):
    ...
    def click_on_the_radio_button(self, choice):
        ...
        return click_button # not present
...
class WebTablePage(BasePage):
    ...
    def search_people(self, key_world):
        self.element_is_visible(self.locators.SEARCH_INPUT).send_keys(key_world)
    ...
    def delete_person(self):    #mistake
...
class ButtonsPage(BasePage):
    ...
    def click_on_different_button(self, type_click):
        ...
        if type_click == "right":
            on_element = self.element_is_visible(self.locators.RIGTH_CLICK)
            self.action_rigth_click(on_element)
            return self.check_clicked_on_the_button(self.locators.SUCCESS_RIGTH)
        if type_click == "click":
...
class DownloadPage(BasePage):
    ...
    def download_file(self):
        ...
        path_name_file = rf"/Users/sergeyl/Documents/autotest_python{random.randint(0, 999)}.jpg"
